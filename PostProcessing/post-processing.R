...
###############################################################################
post.process <- function(folder.data, role.meas, clust.algo, comdet.algo, overlap.threshold, force=FALSE)
{	
	...
	draw.hiveplots(folder.data, role.meas, clust.algo, comdet.algo, sample.size=NA, overlap.threshold, force)
}
