...
# have 4 measures, so we just do (from the OS console): 
# 	cd ~/eclipse/workspaces/Networks/Orleans/src/old_dir
# 	Rscript p09-anova.R 1;Rscript p09-anova.R 2;Rscript p09-anova.R 3;Rscript p09-anova.R 4
###############################################################################
library("car")
#library("multcomp")
